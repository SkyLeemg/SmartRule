...
import com.vitec.task.smartrule.activity.BaseFragmentActivity;
...
public class UnuseMainActivity extends BaseFragmentActivity implements ISettable,View.OnClickListener {

    private static final String TAG = "UnuseMainActivity";
