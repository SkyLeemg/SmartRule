 ...
 *
 */
public class MeasureFragmentRecordControllerImpl implements IFragmentController,BottomNavigationBar.OnTabSelectedListener {
    ...
    public MeasureFragmentRecordControllerImpl(FragmentActivity activity, BottomNavigationBar bottomNavigationBar, List<RulerCheckOptions> checkOptionsList) {
